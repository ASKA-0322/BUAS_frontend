...
<script>
    ...
    export default {
      ...
      mounted () {
        axios.get('http://172.20.10.4:8081/consum/area').then(function(response){
            var value =response.data
            console.log(value)
            get_consumarea(value)
        })
        // axios.get('http://172.20.10.4:8081/consum/category/').then(function(response){
        //     var value =response.data
        //     console.log(value)
        //     get_consumarea(value)
        // })
